...
namespace Async_Inn.Controllers
{
    ...
    public class HotelRoomController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateHotelRoomInHotel(int hotelId, int roomId, [FromBody] HotelRoom updatedHotelRoom)
        {
            ...
            var room = await _context.HotelRoom.FirstOrDefaultAsync(r => r.RoomID == roomId && r.HotelID == hotelId);
            if (room == null)
            {
        ...
        {
            var hotelRoom = await _context.HotelRoom.FirstOrDefaultAsync(r => r.HotelID == hotelId && r.RoomID == roomID);
            if (hotelRoom == null)
            {
                return NotFound();
            }
